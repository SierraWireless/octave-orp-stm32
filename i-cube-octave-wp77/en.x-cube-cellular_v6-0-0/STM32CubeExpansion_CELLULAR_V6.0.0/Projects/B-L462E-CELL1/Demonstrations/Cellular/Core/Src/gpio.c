...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, MDM_PWR_EN_OUT_Pin|SF_EN_Pin|LED2_Pin|LED3_Pin
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin */
  GPIO_InitStruct.Pin = MDM_PWR_EN_OUT_Pin|SF_EN_Pin|LED2_Pin|LED3_Pin
                          |ST33_VCC_CTRL_Pin;
  ...
  GPIO_InitStruct.Pin = USER_BUTTON_Pin|INT_ACC_Pin|INT_MAG_Pin;
  ...
  /*Configure GPIO pins : PC1 PC0 PC7 */
