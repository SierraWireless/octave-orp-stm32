...
#define MODEM_TX_GPIO_PORT      ((GPIO_TypeDef *)USART3_TX_GPIO_Port)   /* for STWIN: GPIOD       */
#define MODEM_TX_PIN            USART3_TX_Pin                           /* for STWIN: GPIO_PIN_8  */
#define MODEM_RX_GPIO_PORT      ((GPIO_TypeDef *)USART3_RX_GPIO_Port)   /* for STWIN: GPIOD       */
#define MODEM_RX_PIN            USART3_RX_Pin                           /* for STWIN: GPIO_PIN_9  */
#define MODEM_CTS_GPIO_PORT     ((GPIO_TypeDef *)USART3_CTS_GPIO_Port)  /* for STWIN: GPIOB       */
#define MODEM_CTS_PIN           USART3_CTS_Pin                          /* for STWIN: GPIO_PIN_13 */
#define MODEM_RTS_GPIO_PORT     ((GPIO_TypeDef *)USART3_RTS_GPIO_Port)  /* for STWIN: GPIOB       */
#define MODEM_RTS_PIN           USART3_RTS_Pin                          /* for STWIN: GPIO_PIN_1  */
...
/* input */
#define MODEM_RING_GPIO_PORT    ((GPIO_TypeDef *)MDM_RING_INT_GPIO_Port)  /* for DiscoL496: GPIOH      */
#define MODEM_RING_PIN          MDM_RING_INT_Pin                          /* for DiscoL496: GPIO_PIN_2 */
