...
#define ECHOCLIENT1_ACTIVATED                    (0U)  /** 0: echoclient instance1 NOT activated
                                                         *    need an interaction to activate it
                                                         * 1: echoclient instance1 activated as soon data is ready */
#if (USE_RTC == 1)
#define ECHOCLIENT_DATETIME_ACTIVATED            (0)  /** 0: echoclient instance1 doesn't request Date/Time
...
/******Ashu Modification******/
//Changed from 3U to 1U as echo and PIng commands are not to implemented in Phase 1
...
#define USE_SENSORS    (1U)  /* 0: not activated, 1: activated */
