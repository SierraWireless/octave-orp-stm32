...
#if (USE_SENSORS == 1)
#include "stm32l4s5i_iot01.h" /* Leds, Buttons, … */
#include "stm32l4s5i_iot01_accelero.h" /* Accelerometer sensor*/
#include "stm32l4s5i_iot01_gyro.h" /* Gyroscope sencor */
#include "stm32l4s5i_iot01_hsensor.h" /* Humidity sensor */
#include "stm32l4s5i_iot01_magneto.h" /* Magnetometer sensor */
#include "stm32l4s5i_iot01_psensor.h" /* Pressure sensor */
#include "stm32l4s5i_iot01_tsensor.h" /* Temperature sensor */
#endif /* USE_SENSORS == 1 */
