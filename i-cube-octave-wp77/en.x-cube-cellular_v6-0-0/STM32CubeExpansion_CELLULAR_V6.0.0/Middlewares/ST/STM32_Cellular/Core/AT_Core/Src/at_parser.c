...
/******Ashu Modification******/
//to increase frame width
#define FILTER_SOCKET_TRACES   (1U)   /* filter display of big frame in trace output */
/***** Ashu MOdification to increase from 160 to 360 to show long ORP At commands - JSON types ******/
#define FILTER_DEFAULT_LENGH   (360U)  /* default length to activate the filter */
